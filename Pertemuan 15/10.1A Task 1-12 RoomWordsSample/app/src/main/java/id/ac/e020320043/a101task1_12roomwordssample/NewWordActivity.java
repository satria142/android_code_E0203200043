package id.ac.e020320043.a101task1_12roomwordssample;
...
import id.ac.e020320043.a101task1_12roomwordssample.R;

public class NewWordActivity extends AppCompatActivity {
    private Button mSaveButton;
    public static final String EXTRA_REPLY = "id.ac.e020320043.a101task1_12roomwordssample.REPLY";
    public static final String EXTRA_WORD_ID = "id.ac.e020320043.a101task1_12roomwordssample.REPLY_ID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null) {
            ...
            String word = intent.getStringExtra(MainActivity.UPDATE_WORD);
            if (!word.isEmpty()) {
